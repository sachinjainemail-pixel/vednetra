...
| `yoga.html` | **Yoga-Fi** — a standalone Yoga & Ayurveda app (self-contained; open directly) |

---

## Yoga-Fi — Yoga &amp; Ayurveda app
...
- **Premium** — a freemium tier layout (Yoga-Fi Plus subscription, one-time courses like a *30-Day Dosha Reset*, live sessions) illustrating monetisation. Demo only — no real payments.
